$(document).ready(function(){
	...
	$('.option').css({"margin":"2px 20px", "border":"solid gray 2px", "width":"100px", "text-align":"center","padding":"4px", "background-color":"rgb(180,180,180)", "cursor":"pointer"});
	$('.option_select').css({"position":"absolute","top":"450px", "left":"20px"});
