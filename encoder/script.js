var alphabet=["a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z"," ",".",",","'","1","2","3","4","5","6","7","8","9","0","$","!","@","#","%","^","&","*","(",")","+","-","=","_","{","}","[","]","|",";",":","<",">","?","/","\n","ƒ","š","œ","ÿ","þ","ý","ü","û","ú","ù","ø","ö","õ","ô","ó","ò","ñ","ð","ï","î","í","ì","ë","ê","é","è","ç","æ","å","ä","ã","â","á","à","ß"];
var letter=1;
var letters=[];
var alphabet2 = new Array(101);
var alpha1=0;
var alpha2=0;
var alpha3=0;
var alpha4=0;
...
$(document).ready(function () {
    ...
    $('.encode_button').click(function(){
        ...
        letters=a.split('');
        letter=1;
        var encode1=Math.floor(Math.random() * 101 + 1);
        var encode2=Math.floor(Math.random() * 101 + 1);
        var encode3=Math.floor(Math.random() * 101 + 1);
        var encode4=Math.floor(Math.random() * 101 + 1);
        alpha1=Math.floor(Math.random() * 101 + 1);
        alpha2=Math.floor(Math.random() * 101 + 1);
        alpha3=Math.floor(Math.random() * 101 + 1);
        alpha4=Math.floor(Math.random() * 101 + 1);
        new_alpha();
